class PaymentMethodsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @payment_method.save
        ...
        format.json { render json: @payment_method.errors, status: :unprocessable_content }
      end
    end
  end
  ...
  def update
    respond_to do |format|
      if @payment_method.update(payment_method_params)
        format.html { redirect_to @payment_method, notice: "Payment method was successfully updated.", status: :see_other }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to payment_methods_path, notice: "Payment method was successfully destroyed.", status: :see_other }
  ...
  private
    ...
    def payment_method_params
      params.expect(payment_method: [ :name, :expense_id ])
    end
end
